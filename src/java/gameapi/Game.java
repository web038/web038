...
public class Game {
    ...
    /**
     * Specifies if the game is over (<code>true</code>) or not (<code>false</code)
     */
     ...
     * <code>player</code> and <code>opponent</code>.
     * 
     * @param player Player (real) participating in the game
     * @param opponent Computer-controlled (virtual) player participating 
     *                 in the game
     */
     ...
     * 
     * @return an unmodifiable list of the players participating in this 
     *         game
     */
    ...
    /**
     * Rolls the dice for the given player and updates the position
     * of the player's counter according to the score
     * 
    ...
    public int rollthedice(Player player){      
        ...
        if(route.indexOf(position)+score >= route.size()){
            /*
             * The counter of the player is standing in front of the 
             * HOME Base but threw a too high score
             * --> Do nothing
             */
        } else if(position == route.get(0) && score != 6){
            /*
             * The counter of the player is standing in the Starting Square
             * and the player didn't threw a six.
             * --> Do nothing
             */
        } else if(position == route.get(0) && score == 6){
            /**
            ...
            /**
             * Test if one of the opponent's counters is knocked off because
             * the player's counter moves to the new position
             */ 
            testKnockOff(player, route.get(1));
             ...
             * the player's counter moves to the new position
             */ 
            testKnockOff(player, newposition);

            /**
             * Test if the figure of the player reached the HOME Base
